...
// Earth HRC Index — Tile Recompute — SF Bay — v2.0
//
...
//
// Verify: SF Bay mean HRC should be ~4.5–6.0 (Mediterranean)
//         If above 8.0, thermal radiation sign is wrong
// ============================================================
...
Export.table.toDrive({
  collection:     withEco,
  description:    'tiles_sfbay_v2_0',
  folder:         'EarthHRC',
  fileNamePrefix: 'tiles_sfbay_v2_0',
  fileFormat:     'CSV'
});
