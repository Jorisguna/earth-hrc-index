...
// Earth HRC Index — Tile Recompute — Los Angeles — v2.0
//
...
//
// Verify: LA mean HRC should be ~2.5–3.5 (semi-arid)
//         If above 6.0, thermal radiation sign is wrong
// ============================================================
...
Export.table.toDrive({
  collection:     withEco,
  description:    'tiles_la_v2_0',
  folder:         'EarthHRC',
  fileNamePrefix: 'tiles_la_v2_0',
  fileFormat:     'CSV'
});
