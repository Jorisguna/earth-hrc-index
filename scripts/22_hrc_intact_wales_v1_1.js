// ============================================================
// 22_hrc_intact_wales_v1_1.js
// Earth HRC Index — Intact Site Reference — Wales
//
...
print('HRC range (all tiles, sanity check — Wales expect ~6.5):',
...
Map.addLayer(
  ...
  'HRC Score (Wales, Apr 2025–Mar 2026)'
);
...
Export.table.toDrive({
  collection:     results,
  description:    'HRC_Intact_Wales_v1_1',
  folder:         'EarthHRC',
  fileNamePrefix: 'HRC_Intact_Wales_v1_1',
  fileFormat:     'CSV',
