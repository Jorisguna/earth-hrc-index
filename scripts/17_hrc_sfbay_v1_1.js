// ============================================================
// 17_hrc_sfbay_v1_1.js
// Earth HRC Index — San Francisco Bay Area — Methodology v1.1
//
// Change from v1.0:
...
Map.addLayer(
  ...
  'HRC Score v1.1 (SF Bay, 12-month mean)'
);

// ── Step 9: Export ────────────────────────────────────────────
Export.table.toDrive({
  collection:     samplePoints,
  description:    'HRC_SFBay_v1_1',
  folder:         'EarthHRC',
  fileNamePrefix: 'HRC_SFBay_v1_1',
  fileFormat:     'CSV',
