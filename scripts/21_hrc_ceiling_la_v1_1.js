// ============================================================
// 21_hrc_ceiling_la_v1_1.js
// Earth HRC Index — Penman-Monteith physical ceiling — SF Bay
//
...
//
//   Run 3 — SF Bay
//     region     = ee.Geometry.Rectangle([-119.0, 33.6, -117.4, 34.4])
//     regionName = 'LosAngeles'
//     exportName = 'HRC_Ceiling_LosAngeles'
//
...
//
// Period: Apr 2025 – Mar 2026 (12 months — same window as
//         hrc_score v1.1, so ceiling and score
//         are directly comparable — v1.1)
// Dataset: ECMWF/ERA5_LAND/DAILY_AGGR (Tier C)
// ============================================================

var region     = ee.Geometry.Rectangle([-119.0, 33.6, -117.4, 34.4]);
var regionName = 'LosAngeles';
var exportName = 'HRC_Ceiling_LosAngeles';

Map.centerObject(region, 8);

// ── ERA5 climate variables — 60-month mean ───────────────────
var era5 = ee.ImageCollection('ECMWF/ERA5_LAND/DAILY_AGGR')
  .filterDate('2025-04-01', '2026-04-01')
  .filterBounds(region);
