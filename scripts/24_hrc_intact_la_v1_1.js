// ============================================================
// 24_hrc_intact_la_v1_1.js
// Earth HRC Index — Intact Site Reference — Los Angeles
//
...
print('HRC range (all tiles, sanity check — LA expect ~4.5):',
...
// LA has very sparse IUCN I–IV coverage (3–15 pixels per ecoregion).
// Expanding to I–VI gives 23–60 pixels — minimum viable benchmark.
// reference_filter metadata records which filter was used.
// Wales and SF Bay use I–IV; only expand to I–VI if pixel count < 20.
...
Map.addLayer(
  ...
  'HRC Score (Los Angeles, Apr 2025–Mar 2026)'
);
...
Export.table.toDrive({
  collection:     results,
  description:    'HRC_Intact_LosAngeles_v1_1',
  folder:         'EarthHRC',
  fileNamePrefix: 'HRC_Intact_LosAngeles_v1_1',
  fileFormat:     'CSV',
